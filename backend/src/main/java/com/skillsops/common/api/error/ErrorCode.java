...
public enum ErrorCode {
    ...
    SKILL_VERSION_CONFLICT("SKILL_VERSION_CONFLICT", HttpStatus.CONFLICT),
    SKILL_RESOURCE_URL_REQUIRED("SKILL_RESOURCE_URL_REQUIRED", HttpStatus.UNPROCESSABLE_ENTITY),
    SKILL_OFFLINE_NOT_INSTALLABLE("SKILL_OFFLINE_NOT_INSTALLABLE", HttpStatus.CONFLICT),
    RATING_REQUIRES_INSTALL("RATING_REQUIRES_INSTALL", HttpStatus.UNPROCESSABLE_ENTITY),
